...
// In the issie extracted example below, 
// helper functions genPortInfo, rotate90Edge, rotate90Port, 
// rotateSegments90, rotateStartDest, getOrientationOfEdge and rotateSegments
// all make up to does a part of the work for the final autoroute. 
...
let inline genPortInfo edge position =  // structural abstraction helper function
    { Edge = edge; Position = position }

/// Returns an edge rotated 90 degrees anticlockwise
let inline rotate90Edge (edge: Edge) =  // structural abstraction helper function
    match edge with
...
let inline rotate90Port (port: PortInfo) =  // structural abstraction helper function
...
let rotateSegments90 initialOrientation =  // structural abstraction helper function
    let horizontal i =
...
let rec rotateStartDest (target: Edge) ((start, dest): PortInfo * PortInfo) =  // structural abstraction helper function
...
let inline getOrientationOfEdge (edge: Edge) =  // structural abstraction helper function
    match edge with
...
let rec rotateSegments (target: Edge) (wire: {| edge: Edge; segments: Segment list |}) =  // structural abstraction helper function
